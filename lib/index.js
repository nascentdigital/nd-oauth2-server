...
exports.OAuth2Error = require('./error');
...
class OAuth2Server {
    ...
    createUser(username, password, scopes, enabled = true, userData = {}) {

        // TODO: add validation

        // register using provider
        return this.oauth2Provider.createUser(username, password, scopes, enabled, userData);
    }
